...
export class alterTag1567479546267 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE `tipo_tag` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `tag` ADD `habilitado` tinyint NOT NULL");
        await queryRunner.query("ALTER TABLE `tag` ADD `tipoTagId` int NOT NULL");
        await queryRunner.query("ALTER TABLE `tipo_falla` CHANGE `codificacionDeFalla` `codificacionDeFalla` varchar(255) NOT NULL");
        await queryRunner.query("ALTER TABLE `plantilla_ronda` DROP COLUMN `horarios`");
        await queryRunner.query("ALTER TABLE `plantilla_ronda` ADD `horarios` text NOT NULL");
        await queryRunner.query("ALTER TABLE `sistema` CHANGE `KKS` `KKS` varchar(255) NOT NULL");
        ...
        await queryRunner.query("ALTER TABLE `tag` ADD CONSTRAINT `FK_f99e302d10e5ab82855ab1a7a82` FOREIGN KEY (`tipoTagId`) REFERENCES `tipo_tag`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `tag` DROP FOREIGN KEY `FK_f99e302d10e5ab82855ab1a7a82`");
        ...
        await queryRunner.query("ALTER TABLE `sistema` CHANGE `KKS` `KKS` varchar(255) NULL");
        await queryRunner.query("ALTER TABLE `plantilla_ronda` DROP COLUMN `horarios`");
        await queryRunner.query("ALTER TABLE `plantilla_ronda` ADD `horarios` json NULL");
        await queryRunner.query("ALTER TABLE `tipo_falla` CHANGE `codificacionDeFalla` `codificacionDeFalla` varchar(255) NULL");
        await queryRunner.query("ALTER TABLE `tag` DROP COLUMN `tipoTagId`");
        await queryRunner.query("ALTER TABLE `tag` DROP COLUMN `habilitado`");
        await queryRunner.query("DROP TABLE `horario`");
        await queryRunner.query("DROP TABLE `tipo_tag`");
    }

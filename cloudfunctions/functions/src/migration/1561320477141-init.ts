...
export class init1561320477141 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `plantilla_guia_maniobra` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `valor_campo_maniobra` ADD CONSTRAINT `FK_3f07f54c600a9d6ef4b9cb7b82a` FOREIGN KEY (`guiaManiobraId`) REFERENCES `guia_maniobra`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `campo_maniobra` ADD CONSTRAINT `FK_ad7c031ca2a03327bd9b309f3ef` FOREIGN KEY (`sistemaId`) REFERENCES `sistema`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        await queryRunner.query("ALTER TABLE `campo_maniobra` ADD CONSTRAINT `FK_49c48adbebdf18dd533a8c1ca5a` FOREIGN KEY (`plantillaGuiaManiobraId`) REFERENCES `plantilla_guia_maniobra`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("DROP TABLE `campo_maniobra`");
        await queryRunner.query("DROP INDEX `IDX_d6db1488d24991a167f65eb188` ON `valor_campo_maniobra`");
        await queryRunner.query("DROP INDEX `IDX_3f07f54c600a9d6ef4b9cb7b82` ON `valor_campo_maniobra`");
        await queryRunner.query("DROP TABLE `valor_campo_maniobra`");
        await queryRunner.query("DROP INDEX `IDX_8e97b26b2a8baddad3e139b0b7` ON `guia_maniobra`");
        await queryRunner.query("DROP TABLE `guia_maniobra`");
        ...
        await queryRunner.query("DROP TABLE `plantilla_guia_maniobra`");

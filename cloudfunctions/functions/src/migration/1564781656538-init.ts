...
export class init1564781656538 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `join_report` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `joinColumn` varchar(255) NOT NULL, `joinAlias` varchar(255) NOT NULL, `joinWhere` varchar(255) NULL, `reportId` int NOT NULL, `joinTypeId` int NOT NULL, INDEX `IDX_cf44e7badf7c1da27b5cbbedec` (`reportId`), INDEX `IDX_d2aff19ca457a315cd378d2346` (`joinTypeId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `report` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `description` varchar(255) NOT NULL, `from` varchar(255) NOT NULL, `where` varchar(255) NULL, `entityAlias` varchar(255) NOT NULL, `select` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `estado_falla` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `posicion` int NULL, `color` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `tipo_campo_ronda` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `plantilla_ronda` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `funcionamientoSistema` tinyint NOT NULL, `obligatorioSistema` tinyint NOT NULL, `funcionamientoEquipo` tinyint NOT NULL, `obligatorioEquipo` tinyint NOT NULL, `horarioId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `campo_ronda` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `descripcion` text NOT NULL, `nombre` varchar(255) NOT NULL, `valorNormal` varchar(255) NOT NULL, `valorMin` varchar(255) NOT NULL, `valorMax` varchar(255) NOT NULL, `equipamientoId` int NOT NULL, `tipoCampoRondaId` int NOT NULL, `unidadMedidaId` int NOT NULL, `plantillaRondaId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `valor_campo_ronda` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `valor` varchar(255) NOT NULL, `valorNormal` varchar(255) NOT NULL, `rondaId` int NOT NULL, `campoRondaId` int NOT NULL, `notificacionFallaId` int NULL, INDEX `IDX_20916c07f9600c5749f8276c19` (`rondaId`), INDEX `IDX_8e5422b803a250b77c12f3e757` (`campoRondaId`), INDEX `IDX_9eb302870ed2f6dfe236c71212` (`notificacionFallaId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `notificacion_falla` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `descripcion` varchar(255) NOT NULL, `estadoFallaId` int NOT NULL, `tipoFallaId` int NOT NULL, INDEX `IDX_afb5f65658b61e3b5b0fd93ff6` (`estadoFallaId`), INDEX `IDX_80f5626e7bfdf906d8561bafe3` (`tipoFallaId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `valor_campo_maniobra` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `valor` tinyint NOT NULL, `valorNormal` tinyint NOT NULL, `guiaManiobraId` int NOT NULL, `notificacionFallaId` int NULL, `campoManiobraId` int NOT NULL, INDEX `IDX_3f07f54c600a9d6ef4b9cb7b82` (`guiaManiobraId`), INDEX `IDX_d195f9af34594d79c8a356ebe4` (`notificacionFallaId`), INDEX `IDX_892036c32838dd214367300e80` (`campoManiobraId`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `ronda` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `porcentaje` float(5,2) NOT NULL, `tiempoRondaMinutos` int NULL, `userId` int NOT NULL, `estadoRondaId` int NOT NULL, `plantillaRondaId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `lectura_tag` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `tagId` int NOT NULL, `rondaId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `sistema` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `descripcion` varchar(255) NOT NULL, `plantaId` int NOT NULL, `tipoSistemaId` int NOT NULL, `tagId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `campo_maniobra` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `descripcion` text NOT NULL, `valorNormal` tinyint NOT NULL, `sistemaId` int NOT NULL, `plantillaGuiaManiobraId` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("DROP TABLE `lectura_tag`");
        await queryRunner.query("DROP TABLE `ronda`");
        ...
        await queryRunner.query("DROP INDEX `IDX_8e5422b803a250b77c12f3e757` ON `valor_campo_ronda`");
        await queryRunner.query("DROP INDEX `IDX_20916c07f9600c5749f8276c19` ON `valor_campo_ronda`");
        await queryRunner.query("DROP TABLE `valor_campo_ronda`");
        await queryRunner.query("DROP TABLE `campo_ronda`");
        await queryRunner.query("DROP TABLE `plantilla_ronda`");
        await queryRunner.query("DROP TABLE `horario`");
        await queryRunner.query("DROP TABLE `lista_ronda`");

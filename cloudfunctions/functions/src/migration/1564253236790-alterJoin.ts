...
export class alterJoin1564253236790 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `join_report` ADD `joinWhere` varchar(255) NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `join_report` DROP COLUMN `joinWhere`");

...
exports.alterNotFallas1564762539014 = void 0;
class alterNotFallas1564762539014 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("ALTER TABLE `valor_campo_ronda` ADD `notificacionFallaId` int NULL");
            yield queryRunner.query("CREATE INDEX `IDX_9eb302870ed2f6dfe236c71212` ON `valor_campo_ronda` (`notificacionFallaId`)");
            ...
            yield queryRunner.query("ALTER TABLE `valor_campo_ronda` ADD CONSTRAINT `FK_9eb302870ed2f6dfe236c71212e` FOREIGN KEY (`notificacionFallaId`) REFERENCES `notificacion_falla`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION");
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("ALTER TABLE `valor_campo_ronda` DROP FOREIGN KEY `FK_9eb302870ed2f6dfe236c71212e`");
            ...
            yield queryRunner.query("DROP INDEX `IDX_9eb302870ed2f6dfe236c71212` ON `valor_campo_ronda`");
            yield queryRunner.query("ALTER TABLE `valor_campo_ronda` DROP COLUMN `notificacionFallaId`");
...
exports.alterNotFallas1564762539014 = alterNotFallas1564762539014;
//# sourceMappingURL=1564762539014-alterNotFallas.js.map
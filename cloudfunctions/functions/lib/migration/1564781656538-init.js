...
exports.init1564781656538 = void 0;
class init1564781656538 {
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query("CREATE TABLE `estado_falla` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `posicion` int NULL, `color` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
            ...
            yield queryRunner.query("CREATE TABLE `tipo_sistema` (`createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updateAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `id` int NOT NULL AUTO_INCREMENT, `nombre` varchar(255) NOT NULL, `posicion` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
...
exports.init1564781656538 = init1564781656538;
//# sourceMappingURL=1564781656538-init.js.map